...
- [Current official published opening squad v1](research/current-official-published-opening-squad-v1.md) — full-candidate official `ep_next` Gameweek 1 overlay, immutable product handoff, legal six-week opening baseline and unchanged-scenario diagnostic.
...
- [Current official injury boundary audit v1](research/current-official-injury-boundary-audit-v1.md) — exact raw-row reconciliation of the cutoff-safe Premier League injury capture against the selected squad and its direct alternatives, preserving unresolved identities without guessing.
...
- [Public-projection opening-squad prospective outcome evaluation v1](research/public-projection-opening-squad-prospective-outcome-evaluation-v1.md) — incremental exact-FPL scoring of the final frozen Solio challenger against its same-artifact autoFPL incumbent, with no automatic promotion.
- [Official-published opening-squad prospective outcome evaluation v1](research/official-published-opening-squad-prospective-outcome-evaluation-v1.md) — incremental exact-FPL scoring of the frozen official `ep_next` baseline against its same-artifact autoFPL v2 incumbent, with no automatic promotion.
