...
- [FBref Championship playing time v1](data/sources/fbref-championship-playing-time-v1.md) — fixed-URL Byparr capture and stable-match-ID schedule boundaries for 2025/26 promoted-player history.
