...
- [Current official published opening squad v1](research/current-official-published-opening-squad-v1.md) — full-candidate official `ep_next` Gameweek 1 overlay, legal six-week opening baseline and unchanged-scenario diagnostic.
