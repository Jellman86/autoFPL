...
| [`solio-public-projections/v1`](solio-public-projections-v1.md) | Admitted for prospective shadow capture | Cutoff-bound public Gameweek 1 point means used only for an immutable, non-serving opening-squad challenger |
...
| [`fbref-championship-playing-time/v1`](fbref-championship-playing-time-v1.md) | Admitted for shadow capture | Fixed-URL 2021/22–2025/26 Championship populations, reviewed current-player chronology and promoted-club schedule evidence for prior-competition coverage research |
