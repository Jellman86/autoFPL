    ...
    public async Task V1_document_exposes_the_supported_http_contract()
    {
        ...
        Assert.True(
            paths.TryGetProperty(
                ...
                out JsonElement evidenceReviewPath));
        Assert.Equal(
            "GetCurrentEvidenceSemanticReview",
            evidenceReviewPath
                .GetProperty("get")
                .GetProperty("operationId")
                .GetString());
        ...
        Assert.True(
            paths.TryGetProperty(
                ...
                out JsonElement selectionScenarioScorePath));
        Assert.Equal(
            "GetCurrentSelectionScenarioScoreShadow",
            selectionScenarioScorePath
                .GetProperty("get")
                .GetProperty("operationId")
                .GetString());
        Assert.True(
            paths.TryGetProperty(
                ...
                out JsonElement selectionRoleStrategiesPath));
        Assert.Equal(
            "GetCurrentSelectionRoleStrategiesShadow",
            selectionRoleStrategiesPath
                .GetProperty("get")
                .GetProperty("operationId")
                .GetString());
        Assert.True(
