...
public sealed class LineupValidationExceptionHandler : IExceptionHandler
{
    ...
    {
        if (exception is not LineupValidationException validationException)
        {
            return false;
        }
