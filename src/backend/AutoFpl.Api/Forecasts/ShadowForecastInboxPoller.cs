...
public sealed class ShadowForecastInboxPoller : BackgroundService
{
    public const string FilePrefix = "multi-season-shadow-capture-";
    ...
    private readonly MultiSeasonPlayerForecastImporter _importer;
    private readonly ShadowForecastInboxOptions _options;
    private readonly TimeProvider _timeProvider;

    public ShadowForecastInboxPoller(
        MultiSeasonPlayerForecastImporter importer,
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        TimeSpan interval = _options.Interval
            ?? throw new InvalidOperationException(
                "The shadow inbox poller cannot run without an interval.");
