...
public sealed class ExternalEvidenceStressInboxPoller : BackgroundService
{
    public const string FilePrefix = "external-evidence-stress-capture-";
    ...
    private readonly ExternalEvidenceStressImporter _importer;
    private readonly ShadowForecastInboxOptions _options;
    private readonly TimeProvider _timeProvider;

    public ExternalEvidenceStressInboxPoller(
        ExternalEvidenceStressImporter importer,
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        TimeSpan interval = _options.Interval
            ?? throw new InvalidOperationException(
                "The evidence-stress inbox poller requires an interval.");
