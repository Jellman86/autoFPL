...
public sealed class PublicProjectionOpeningSquadInboxPoller
    : BackgroundService
{
    public const string FilePrefix =
        "public-projection-opening-squad-capture-";
    ...
    private readonly PublicProjectionOpeningSquadImporter _importer;
    private readonly ShadowForecastInboxOptions _options;
    private readonly TimeProvider _timeProvider;

    public PublicProjectionOpeningSquadInboxPoller(
        PublicProjectionOpeningSquadImporter importer,
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        TimeSpan interval = _options.Interval
            ?? throw new InvalidOperationException(
                "The public projection inbox poller requires an interval.");
