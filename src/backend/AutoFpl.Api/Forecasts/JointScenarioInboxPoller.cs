...
public sealed class JointScenarioInboxPoller : BackgroundService
{
    public const string FilePrefix = "joint-scenario-shadow-capture-";
    ...
    private readonly JointScenarioShadowImporter _importer;
    private readonly ShadowForecastInboxOptions _options;
    private readonly TimeProvider _timeProvider;

    public JointScenarioInboxPoller(
        JointScenarioShadowImporter importer,
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        TimeSpan interval = _options.Interval
            ?? throw new InvalidOperationException(
                "The scenario inbox poller cannot run without an interval.");
