...
public sealed class InitialSquadQualityInboxPoller : BackgroundService
{
    public const string FilePrefix = "initial-squad-quality-capture-";
    ...
    private readonly InitialSquadQualityShadowImporter _importer;
    private readonly ShadowForecastInboxOptions _options;
    private readonly TimeProvider _timeProvider;

    public InitialSquadQualityInboxPoller(
        InitialSquadQualityShadowImporter importer,
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        TimeSpan interval = _options.Interval
            ?? throw new InvalidOperationException(
                "The initial-squad inbox poller requires an interval.");
