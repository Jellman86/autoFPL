...
public sealed class OfficialPublishedOpeningSquadInboxPoller
    : BackgroundService
{
    public const string FilePrefix =
        "official-published-opening-squad-capture-";
    ...
    private readonly OfficialPublishedOpeningSquadImporter _importer;
    private readonly ShadowForecastInboxOptions _options;
    private readonly TimeProvider _timeProvider;

    public OfficialPublishedOpeningSquadInboxPoller(
        OfficialPublishedOpeningSquadImporter importer,
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        TimeSpan interval = _options.Interval
            ?? throw new InvalidOperationException(
                "The official published inbox poller requires an interval.");
