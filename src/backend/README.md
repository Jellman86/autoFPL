...
- `AutoFpl.Api` exposes liveness, SQLite-aware readiness, official-capture metadata, immutable decision-snapshot persistence/readback and the deterministic validation/outcome routes over HTTP;
